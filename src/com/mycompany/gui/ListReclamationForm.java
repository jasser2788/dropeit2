...
public class ListReclamationForm extends BaseForm{
    ...
    public ListReclamationForm(Resources res ) {
        ...
        addTab(swipe,s1, res.getImage("mesrec.jpg"),"","",res);
        ...
        ArrayList<Reclamation>list = ServiceReclamation.getInstance().affichReclamations();
    ...
    private void addButton(Image img,Reclamation rec , Resources res) {
        ...
        Label objetTxt = new Label("Date : "+String.valueOf(rec.getDaterec()),"NewsTopLine2");
        ...
        Label dateTxt = new Label("objet : "+rec.getType(),"NewsTopLine2");
        
        createLineSeparator();
        
        if(rec.getEtat().equals(true) ) {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ServiceReclamation.getInstance().deleteReclamation(rec.getId())) {
                    ToastBar.Status s = ToastBar.getInstance().createStatus();
                            s.setMessage("Reclamation supprimé !");
