...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder86d7e = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer8ff08 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties07718 = [
        
    ];

    public function getConnection()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getConnection', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getMetadataFactory', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getExpressionBuilder', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'beginTransaction', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getCache', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getCache();
    }

    public function transactional($func)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'transactional', array('func' => $func), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->transactional($func);
    }

    public function commit()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'commit', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->commit();
    }

    public function rollback()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'rollback', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getClassMetadata', array('className' => $className), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'createQuery', array('dql' => $dql), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'createNamedQuery', array('name' => $name), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'createQueryBuilder', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'flush', array('entity' => $entity), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'clear', array('entityName' => $entityName), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->clear($entityName);
    }

    public function close()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'close', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->close();
    }

    public function persist($entity)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'persist', array('entity' => $entity), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'remove', array('entity' => $entity), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'refresh', array('entity' => $entity), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'detach', array('entity' => $entity), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'merge', array('entity' => $entity), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getRepository', array('entityName' => $entityName), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'contains', array('entity' => $entity), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getEventManager', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getConfiguration', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'isOpen', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getUnitOfWork', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getProxyFactory', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'initializeObject', array('obj' => $obj), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'getFilters', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'isFiltersStateClean', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'hasFilters', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return $this->valueHolder86d7e->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer8ff08 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder86d7e) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder86d7e = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder86d7e->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, '__get', ['name' => $name], $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        if (isset(self::$publicProperties07718[$name])) {
            return $this->valueHolder86d7e->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder86d7e;
    ...
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;
    ...
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, '__isset', array('name' => $name), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;
    ...
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, '__unset', array('name' => $name), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;
    ...
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, '__clone', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        $this->valueHolder86d7e = clone $this->valueHolder86d7e;
    }

    public function __sleep()
    {
        $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, '__sleep', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;

        return array('valueHolder86d7e');
    }
    ...
    {
        $this->initializer8ff08 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer8ff08;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer8ff08 && ($this->initializer8ff08->__invoke($valueHolder86d7e, $this, 'initializeProxy', array(), $this->initializer8ff08) || 1) && $this->valueHolder86d7e = $valueHolder86d7e;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder86d7e;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder86d7e;
    }
}
